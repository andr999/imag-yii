...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 05 2017 г., 21:36
...
(1, 'Products/Product1/6259f4.jpg', 1, 0, 'Product', 'ec419b45cb-3', ''),
(2, 'Products/Product1/c9f983.jpg', 1, 0, 'Product', 'ef5ec1e768-4', ''),
(3, 'Products/Product1/05f98e.jpg', 1, 0, 'Product', 'ef5ec1e768-5', ''),
(4, 'Products/Product1/c35056.jpg', 1, 0, 'Product', '03e5decccb-6', ''),
(5, 'Products/Product1/7db48c.jpg', 1, 0, 'Product', 'ec419b45cb-2', ''),
(6, 'Products/Product1/de99a6.jpg', 1, 1, 'Product', '9de02aac42-1', ''),
(7, 'Products/Product1/6a0892.jpg', 1, NULL, 'Product', '094664a26b-7', ''),
(8, 'Products/Product1/f196c0.jpg', 1, NULL, 'Product', 'fd55b5ef55-8', ''),
(9, 'Products/Product1/fe0542.jpg', 1, NULL, 'Product', '7db5e5b6ed-9', '');
...
('m000000_000000_base', 1489943917),
('m140622_111540_create_image_table', 1489943934),
('m140622_111545_add_name_to_image_table', 1489943934);
...
(1, '2017-01-14 18:06:06', '2017-01-14 18:06:06', 1, 56, '1', 'andrey', 'user@mail.ru', '111', '11122'),
(2, '2017-01-15 17:51:26', '2017-01-15 17:51:26', 1, 20, '0', 'andrey', 'user@mail.ru', '111', '1112233'),
(3, '2017-01-15 17:52:02', '2017-01-15 17:52:02', 1, 20, '0', 'andrey', 'user@mail.ru', '111', '1112233'),
(4, '2017-01-15 17:55:18', '2017-01-15 17:55:18', 1, 100, '0', 'andrey', 'user@mail.ru', '111', '111223344');
...
(9, 26, 'Брюки Kira Plastinina 17-07-17418-FL-58 L', NULL, 100, NULL, NULL, 'product1.jpg', '0', '0', '0'),
...
(13, 29, 'Cумка Michael Kors Bedford Красная', '\r\n\r\nОсобенность стиля Michael Kors заключается в том, что простота его коллекций гармонирует с роскошью. Этому дизайнеру под силу объединить американский утилитаризм в манере одеваться с европейской изысканностью и шармом. Все его работы отличает изящная утонченность, которая рождается из строгих, почти примитивных линий. Все аксессуары поддерживают общий стиль человека с безупречным вкусом.\r\n\r\nМодели Michael Kors могут оставаться оригинальными, стильными и неотразимыми в течение многих лет, что особо важно для покупательниц, не желающих постоянно обновлять свой гардероб.', 100, NULL, NULL, 'no-image.png', '0', '0', '0'),
...
(1, 'admin', '$2y$13$X4w8.bK/QI36HWKdUKRLVeos9ko81ZCnFeVGUl2ubVeciTKhwrUNO', 't8OQjUDLaqa6Xg8Tx818cHb-HxsINoc8');
